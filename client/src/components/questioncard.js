...
function SingleQuestion() {
    ...
    const handleDelete = async () => {
        try {
            await axios.delete('https://whirlpool-christian-d7caed119382.herokuapp.com:5001/api/deleteQuestion/' + question.id);
            axios.delete('https://whirlpool-christian-d7caed119382.herokuapp.com:5001/api/deleteComments/' + question.title);
    ...
    useEffect(() => {
        axios.get('https://whirlpool-christian-d7caed119382.herokuapp.com:5001/api/singleQuestion/' + question.id)
            .then(res => {
                let data = res.data;
                setWienerBalls(data);
                console.log(JSON.stringify(data.image));

                setQuePic("https://whirlpool-christian-d7caed119382.herokuapp.com:5001/questionImages/" + data.image)
